...
PATHOUT_corr='E:\Inhibition\inhibition_data\FC_data\repeat\high_high\corr\';
cd(PATHOUT);
...
for s=1:len
    ...
    clear FC_data;
    files=dir([Path_bs, subj{s}, filesep,'ERP_data', filesep, 'timefreq_connectn_corr*']);
    ...
    save([PATHOUT_corr,num2str(s),'_corr.mat'],'FC_data');
end
