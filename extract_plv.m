...
PATHOUT_plv='E:\target\FC_data\target8\repeat\plv\';
cd(PATHOUT);
...
for s=1:len
    ...
    clear FC_data;
    files=dir([Path_bs, subj{s}, filesep,'ERP_data', filesep, 'timefreq_connectn_plv*']);
    ...
    save([PATHOUT_plv,num2str(s),'_plv.mat'],'FC_data');
end