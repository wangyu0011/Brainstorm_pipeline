...
PATHOUT_cohere='E:\Inhibition\inhibition_data\FC_data\repeat\high_high\cohere\';
cd(PATHOUT);
...
for s=1:len
    ...
    sFiles = bst_process('CallProcess', 'process_cohere1n', sFiles, [], ...
        ...
        'includebad',   1, ...
        'removeevoked', 0, ...
        'cohmeasure',   1, ...  % Magnitude-squared
        'maxfreqres',   2, ...
        'maxfreq',      60, ...
        'outputmode',   1,...
        'save',           1, ...
